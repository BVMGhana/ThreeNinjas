    ...
    <section id="analytics" class="w-full h-fit px-1 my-8">
        <div class="wrapper w-full flex flex-wrap items-center justify-center gap-[15px] lg:gap-[10px]">
          <div class="container w-[165px] sm:w-[185px] lg:w-[190px] h-[165px] sm:h-[185px] lg:h-[190px]
            ...
            <span class="num text-[#fff] grid place-items-center font-semibold text-[3em]" :data-val="2000+predictionsCount">0</span>
          ...
          <div class="container w-[165px] sm:w-[185px] lg:w-[190px] h-[165px] sm:h-[185px] lg:h-[190px]
            ...
            <span class="num text-[#fff] grid place-items-center font-semibold text-[3em]" :data-val="1000+usersCount">0</span>
          ...
          <div class="container w-[165px] sm:w-[185px] lg:w-[190px] h-[165px] sm:h-[185px] lg:h-[190px]
            ...
            <span class="num text-[#fff] grid place-items-center font-semibold text-[3em]" :data-val="80+usersCount">0</span>
          ...
          <div class="container w-[165px] sm:w-[185px] lg:w-[190px] h-[165px] sm:h-[185px] lg:h-[190px]
            ...
            <span class="num text-[#fff] grid place-items-center font-semibold text-[3em]" :data-val="100+usersCount">0</span>
